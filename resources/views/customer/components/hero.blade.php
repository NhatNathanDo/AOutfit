...
<section class="relative w-full text-white">
	...
	<div class="relative overflow-hidden rounded-2xl bg-neutral-900">
		<figure class="relative h-[330px] md:h-[430px] lg:h-[490px] w-full">
			<img
				src="https://images.unsplash.com/photo-1515378791036-0648a3ef77b2?q=80&w=2068&auto=format&fit=crop"
				alt="Woman in dotted dress styling in sunlight"
			...
			<div class="absolute -bottom-6 left-1/2 -translate-x-1/2">
				<a href="{{ url('/') }}#shop" class="inline-flex items-center gap-2 btn border-dashed bg-neutral-900/90 px-5 py-2.5 text-sm font-medium ring-1 ring-white/15 shadow/40 transition hover:bg-neutral-800 focus:outline-none focus-visible:ring-white/40">
					<span>Shop Now</span>
		...
		<div class="pt-10 md:pt-12 lg:pt-14 pb-6 md:pb-10 lg:pb-14">
			<div class="w-full">
				<div class="mx-0 rounded-2xl border border-dashed border-white/20 bg-black/90 p-5 md:p-7 lg:p-9">
				{{-- Category pills --}}
					<div class="mb-6 flex flex-wrap items-center gap-2 text-sm text-white/80">
					@php $tabs = ['All', 'Mens', 'Womens', 'Kids']; @endphp
					@foreach($tabs as $i => $tab)
							<a href="#" class="btn btn-outline btn-lg text-sm border-dashed px-4 py-1.5 transition hover:bg-white/10 text-white">{{ $tab }}</a>
					@endforeach
				</div>
					...
					{{-- Left: headline & blurb --}}
						...
						<p class="mt-4 max-w-xl text-base text-white/70">
							Explore a world of fashion at AOutfit, where trends meet affordability. Immerse yourself in the latest styles and seize exclusive promotions.
						</p>
					</div>
						...
						<div class="lg:col-span-7 lg:pl-10 lg:border-l lg:border-dashed lg:border-white/20">
							<div class="grid grid-cols-2 rounded-xl overflow-hidden border border-dashed border-white/20">
								...
								<div class="p-6 md:p-8">
									<div class="text-4xl md:text-5xl font-extrabold">1,500<span class="align-super text-xl">+</span></div>
								...
								<div class="p-6 md:p-8 border-l border-dashed border-white/20">
									<div class="text-4xl md:text-5xl font-extrabold">50<span class="align-super text-xl">+</span></div>
								...
								<div class="p-6 md:p-8 border-t border-dashed border-white/20">
									<div class="text-4xl md:text-5xl font-extrabold">30<span class="align-super text-xl">%</span></div>
								...
								<div class="p-6 md:p-8 border-t border-l border-dashed border-white/20">
									<div class="text-4xl md:text-5xl font-extrabold">95<span class="align-super text-xl">%</span></div>
